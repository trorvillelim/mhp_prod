(function() {
    angular
        ...
        .component('patientFileList', {
            templateUrl : 'components/patient-file-list/patient-file-list.component.html',
            bindings : {
                patientUserId : '<', 
                files : '=', 
    ...
    function Controller(       
        ...
        function activate() {
            vm.query = {
                search_value : '',
                filter_type : 'All',
                order: '-lastModifiedDate_in_millis',
                ...
                reset : function(){
                    ...
                    _me.search_value = '';
                    _me.filter_type = 'All';
                    _me.order = '-lastModifiedDate_in_millis';
                    _me.page = 1;
                }
            };
        ...
        function deleteFile(file){
            ...
            //remove if parent file is empty
            vm.patientFileGlobalFunctions
                    .removeEmptyGroupedFiles();
